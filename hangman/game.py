...
class Game:
    ...
    def generate_word(self) -> str:
        filename = os.path.join(os.path.dirname(__file__), 'WordsStockRus.txt')
        words = []
        ...
        self.__word = words[random_index]
    ...
    def guess_letter(self, letter: str) -> Iterable[str]:
        ...
        if self.game_status != GameStatus.IN_PROGRESS:
            raise InvalidOperationException(f'Inappropriate status of the game: {self.game_status}')
